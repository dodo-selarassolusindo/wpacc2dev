...
<div class="row">
	<div class="col-md-12">
		<div class="card card-info">
			...
			<?= form_open($formAction, ['id'=>'permissionForm', 'class'=>'form-horizontal'])  ?>
			<div class="card-body">
			...
			<div class="card-footer">
				<?=anchor(route_to('permissionList'), lang('Basic.global.Cancel'), ['class'=>'btn btn-secondary float-left']); ?>
