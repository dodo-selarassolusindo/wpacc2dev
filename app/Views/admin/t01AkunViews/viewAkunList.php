		...
		<div class="card card-info">
			...
			<div class="card-body">
				<?= view('Themes/_commonPartialsBs/_alertBoxes'); ?>
					...
					<table id="tableOfAkun" class="table table-striped table-hover using-exportable-data-table" style="width: 100%;">
						<thead>
							<tr>
						...
						<?php foreach ($akunList as $item ) : ?>
							<tr>
								<td class="align-middle text-center text-nowrap">
									...
									<?=anchor('#confirm2delete', '<i class="fas fa-trash"></i>', ['class'=>'btn btn-sm btn-danger btn-delete ml-1', 'data-href'=>route_to('deleteAkun', $item->id)]); ?>
								</td>
...
<?=$this->section('additionalInlineJs') ?>
    ...
    $(document).on('click', '.btn-delete', function(e) {
            ...
            Swal.fire({
                title: "<?= lang('Basic.global.sweet.sureToDeleteTitle', [lang('T01Akuns.akun')]) ?>",
