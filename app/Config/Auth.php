...
public $views = [
    ...
    'forgot'          => 'authViews/forgot',
    'reset'           => 'authViews/reset',
...
public $viewLayout = 'Themes/AdminLTE3/AdminLayout/authLayout';
...
public $personalFields = ['first_name', 'last_name', 'primary_phone', 'picture'];
...
public $passwordValidators = [
    ...
    'App\Libraries\NothingPersonalValidator', // our own validator to counter the PHP 8.1 incompatibility of the original class
