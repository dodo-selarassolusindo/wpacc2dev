    ...
    <div class="sidebar">
        ...
        <?php if (config('Basics')->authImplemented && config('Basics')->theme['sidebar']['user']['visible'] && logged_in() ) { ?>
            <div class="user-panel py-3 d-flex">
                <div class="image">
                    <img src="<?=site_url(user()->picture ?? 'assets/generic-user-avatar.png') ?>" class="img-circle elevation-<?= config('Basics')->theme['sidebar']['user']['shadow'] ?>"
                         alt="User Image">
                </div>
                <div class="info">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-compact" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="<?= route_to('/') ?>" class="nav-link">
                        ...
                        <p>
                            <?=lang('Basic.global.Home')?>
                            <span class="right badge badge-warning"><?=lang('Basic.global.updated')?></span>
                        </p>
                    </a>
                </li>
