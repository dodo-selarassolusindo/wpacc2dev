...
class AuthPermissionModel extends \Myth\Auth\Authorization\PermissionModel
{
    ...
    protected $returnType = "App\Entities\Admin\AuthPermission";
    ...
    {
        $builder = $this->db->table($this->table . " t1")->select("t1.name AS name, t1.description AS description");
